...
def run(pipeline_opts):
    # Configura las opciones del pipeline
    options = PipelineOptions(pipeline_opts, project="jbg-edem")
        ...
        (
            processed_data.fined_vehicles
                ...
                | "Write to BigQuery" >> beam.io.WriteToBigQuery(
                    table = "entregabledataflow:radar_cameras.fined_vehicles", # Required Format: PROJECT_ID:DATASET.TABLE
