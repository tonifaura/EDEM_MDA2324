...
config = {
    'bootstrap.servers': 'localhost:9092',  #Recordar cambio direccion si está dentro de docker.
...
topic = 'T1_Recepcion_avisos'  # El nombre del tópico
consumer.subscribe([topic])

# Loop infinito de consumo de mensajes del topic
try:
    while True:
        msg = consumer.poll(2.0)  # Lee nuevos mensajes cada 1 segundo
