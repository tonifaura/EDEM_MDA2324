...
def run():
    ...
    os.environ['GOOGLE_CLOUD_PROJECT']="vigilant-willow-411714"
    ...
    with beam.Pipeline(argv=pipeline_opts,options=options) as p:
        ...
        (
            processed_data.fined_vehicles
                | "Write to BigQuery" >> beam.io.WriteToBigQuery(
                    table = "vigilant-willow-411714:dataset.tabla", # Required Format: PROJECT_ID:DATASET.TABLE
                    schema=schema, # Required Format: field:TYPE
        ...
        (
            processed_data.non_fined_vehicles 
                ...
                | "Write non_fined_vehicles to PubSub" >> beam.io.WriteToPubSub(topic='projects/vigilant-willow-411714/topics/no-multados')
        )
