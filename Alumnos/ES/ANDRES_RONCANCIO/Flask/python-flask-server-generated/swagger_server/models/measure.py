...
class Measure(Model):
    ...
    """
    def __init__(self, code__id_sensor: str=None, fechamuestreo: str=None, unidad: str=None, medicion: float=None):  # noqa: E501
        """Measure - a model defined in Swagger

        :param code__id_sensor: The code__id_sensor of this Measure.  # noqa: E501
        :type code__id_sensor: str
        ...
        self.attribute_map = {
            'code__id_sensor': 'code (id_sensor)',
            'fechamuestreo': 'fechamuestreo',
            'unidad': 'unidad',
            'medicion': 'medicion'
        }
        self._code__id_sensor = code__id_sensor
    ...
    @property
    def code__id_sensor(self) -> str:
        """Gets the code__id_sensor of this Measure.


        :return: The code__id_sensor of this Measure.
        :rtype: str
        """
        return self._code__id_sensor

    @code__id_sensor.setter
    def code__id_sensor(self, code__id_sensor: str):
        """Sets the code__id_sensor of this Measure.


        :param code__id_sensor: The code__id_sensor of this Measure.
        :type code__id_sensor: str
        """
